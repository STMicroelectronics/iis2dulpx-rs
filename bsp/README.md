...
- mlc_vibration.rs — Machine Learning Core example to detect vibrations.
- pedometer_fifo.rs — Step counting example using fifo.
...
- iis2dulpx_fourd_orientation_detection.json
- iis2dulpx_vibration_monitoring.json
