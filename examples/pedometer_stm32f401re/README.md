# IIS2DULPX Embedded Step Counter on STM32F401RE Nucleo-64

This example demonstrates how to use the **IIS2DULPX** accelerometer sensor's embedded step counter feature on an **STM32F401RE** microcontroller board. The program configures the sensor to detect steps and outputs the step count over UART.
...
- When a step detection interrupt occurs, the program reads the embedded status.
...
- The example uses hardware interrupts to detect step events efficiently.
...
*This README explains the embedded Rust program for embedded step counting on the IIS2DULPX sensor using STM32F401RE.*
